...
Considerations:
- Some heroes are really investment heavy  and not worth building:
	- example is base lass and base ryan
- I think it'll be easier to just list heroes that are worth building and not worth building
...
| Urara    | Ryan         |
|          |              |
- Eventually you will have the resources to build anyone anyways so I guess it's just more so that they should be separated into stages

| Absolute Beginner | Newbie | Late Game |
| ----------------- | ------ | --------- |
| Elesis            |        |           |
| Urara             |        |           |
- Characters are also extremely diverse in this game in terms of purpose. Some are great at AOE some are great at single target bossing.

| AOE  | Single Target | Hybrid | Tank       | Support |
| ---- | ------------- | ------ | ---------- | ------- |
| Mari | Lire          | Elesis | Ronan      | Urara   |
| Vice |               |        | Jin        |         |
|      |               |        | Asin       |         |
|      |               |        | Zero       |         |
|      |               |        | Elesis (T) |         |
...
| ----- | ------------------------------- | ----------------------------------------------- | ----------------------------------------------- | ------------------------------------------------------------- | ------------------------------------- |
| Green | Tia, Ai (T), Sieghart (T)       | Elesis, Callisto, Brammash, Amy (T), Werner (T) | Lire, Lapis, Mayden, Iyoung, Werner             | Mari, Ley, Myst (T), Grandiel (T), Serdin (T), Rin (T), Gaian | Grandiel, Urara, Deia (T), Ley (T)    |
...
| Type           | Unit            | Gameplay                          | Assessment                                                                                    | Build or Nah? |     |
| -------------- | --------------- | --------------------------------- | --------------------------------------------------------------------------------------------- | ------------- | --- |
| Green, Tank    | Tia             | [[GCDC Character Guide#Tia]]      | Okay I guess, prolly good for world and mobbing                                               |               |     |
| Green, Tank    | Ai (T)          |                                   |                                                                                               |               |     |
| Green, Tank    | Sieghart (T)    |                                   |                                                                                               |               |     |
| Green, Assault | Elesis          |                                   | Allrounder, Hard to kill, great damage, team buffs                                            | Yeah          |     |
| Green, Assault | Callisto        | [[GCDC Character Guide#Callisto]] |                                                                                               |               |     |
...
| Green, Ranger  | Iyoung          |                                   |                                                                                               |               |     |
| Green, Ranger  | Werner          |                                   |                                                                                               |               |     |
| Green, Mage    | Mari            |                                   | Pretty good for AOE, and burst deals high damage                                              |               |     |
| Green, Mage    | Ley             |                                   |                                                                                               |               |     |
| Green, Mage    | Myst (T)        |                                   |                                                                                               |               |     |
